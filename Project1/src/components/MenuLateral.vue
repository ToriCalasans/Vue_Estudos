...
//import Rotas from 'src\components\Shared\Links\Link.vue'
</script>
...
<template>
   ...
   <div id="menu">
         ...
         <ul class="relative">
            <li class="relative">
               <a class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out"
                  ...
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" class="w-1 h-1 mr-1" role="img"
      ...
      <!-- <div class="menu container mx-auto px-4">
         <div class="w-60 h-full shadow-md bg-white px-1 absolute">
            <ul class="relative">
               <li class="relative">
                  <router-link
                     ...
                     to="/" data-mdb-ripple="true" data-mdb-ripple-color="dark">
                     <svg aria-hidden="true" focusable="false" data-prefix="fas" class="w-3 h-3 mr-3" role="img"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="currentColor"
                           d="M216 0h80c13.3 0 24 10.7 24 24v168h87.7c17.8 0 26.7 21.5 14.1 34.1L269.7 378.3c-7.5 7.5-19.8 7.5-27.3 0L90.1 226.1c-12.6-12.6-3.7-34.1 14.1-34.1H192V24c0-13.3 10.7-24 24-24zm296 376v112c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V376c0-13.3 10.7-24 24-24h146.7l49 49c20.1 20.1 52.5 20.1 72.6 0l49-49H488c13.3 0 24 10.7 24 24zm-124 88c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20zm64 0c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20z">
                     ...
                     <span class="font-sans">Painel</span>
                  </router-link>
               </li>
               <li class="relative">
                  <router-link
                     class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out"
                     to="/Page1" data-mdb-ripple="true" data-mdb-ripple-color="dark">
                     <span class="font-sans">Processos</span>
                  </router-link>
               </li>
            </ul>
         </div>-->
         <!-- <router-link class=" button btn btn-blue" to="/">
               <span class="font-sans">Painel</span>
            </router-link>    
            <router-link class="button" to="/Page1">
                <span class="font-sans">Processos</span>
            </router-link> 
      </div> -->
   </div>
